...
namespace FinancialApplication.Data.Migrations
{
    ...
    partial class FinancialApplicationDbContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FinancialApplication.Models.ApplicationUser", b =>
                {
                    ...
                    b.Property<string>("ExpoNotificationToken")
                        .HasMaxLength(250)
                    ...
                    b.Property<bool>("ReceivePushNotification")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("FinancialApplication.Models.UserConfirmationCode", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FinancialApplication.Models.UserConfirmationCode", b =>
                {
                    b.HasOne("FinancialApplication.Models.ApplicationUser", "User")
                        .WithMany("UserConfirmationCodes")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade);
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("FinancialApplication.Models.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("FinancialApplication.Models.ApplicationUser", b =>
                {
                    ...
                    b.Navigation("UserConfirmationCodes");
                });
